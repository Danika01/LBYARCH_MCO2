...
1. Open the command line in the project folder (ensure the path is the folder of the project)
...
Runtime will most likely scale linearly (O(n)) as the number of cars increases. The assembly implementation will definitely outperform or match C due to its direct register usage and reduced abstraction. This implementation would be very useful for huge datasets involving millions of data. The use of assembly, registers, and C is brilliant, reducing time and increasing efficiency in computing and operating.
